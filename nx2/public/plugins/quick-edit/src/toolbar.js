import { linkItem, removeLinkItem } from 'https://entmseds-da.live/blocks/edit/prose/plugins/menu/linkItem.js';
import { renderGrouped } from 'https://entmseds-da.live/deps/da-y-wrapper/dist/index.js';
...
async function loadLinkStylesheet() {
  ...
  const resp = await fetch('https://entmseds-da.live/blocks/edit/da-palette/da-palette.css');
